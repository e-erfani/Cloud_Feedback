...
SST_all(SST_all > 1E2) = NaN ; SST_all(SST_all < -100) = NaN ;
SST_0_2 = nanmean(SST_all,3) ;
  SST_glb_0_2 = nansum(nansum(GW2 .* SST_0_2,1),2) ./ nansum(nansum(GW2,1),2)           
...
var2  = double(SST_0_1 - SST_ctrl) ;
var3  = double(SST_0_15 - SST_ctrl) ;
var4  = double(SST_0_2 - SST_ctrl) ;
lat  = lat_msh ;
lon  = lon_msh ; 
...
[Z_adjust4,refvec_bias4] = geoloc2grid(lat,lon,var4, cellsize);   
 ...
 lonlim = [1 360]; 
       ...
       fig_name = strcat('Diff_sst_CESM_ctrl');
        fig_dum = figure(1);
...
var2  = double(SST_0_1 - SST_CO2_2) ;
var3  = double(SST_0_15 - SST_CO2_2) ;
var4  = double(SST_0_2 - SST_CO2_2) ;
lat  = lat_msh ;
lon  = lon_msh ; 
[Z_adjust1,refvec_bias1] = geoloc2grid(lat,lon,var1, cellsize);   
[Z_adjust2,refvec_bias2] = geoloc2grid(lat,lon,var2, cellsize);   
...
[Z_adjust4,refvec_bias4] = geoloc2grid(lat,lon,var4, cellsize);   
 ...
 lonlim = [1 360]; 
       ...
       fig_name = strcat('Diff_sst_CESM_2XCO2');
        fig_dum = figure(2);
      set(fig_dum, 'name', fig_name,'numbertitle','on');
      set(fig_dum,'units','inches','position',[0.3,0.3,14,9]);%,'PaperOrientation','landscape');
      set(fig_dum,'paperpositionmode','auto');
