...
%%%%%%%%%%%   
cellsize = 0.5; 
var1  = double(cldlow_ctrl - cldlow_CO2_2) ;
var2  = double(cldlow_0_2_n - cldlow_CO2_2) ;
var3  = double(cldlow_0_1 - cldlow_CO2_2) ;
var4  = double(cldlow_0_15 - cldlow_CO2_2) ;
lat  = lat_msh ;
lon  = lon_msh ; 
...
[Z_adjust4,refvec_bias4] = geoloc2grid(lat,lon,var4, cellsize);   
 ...
 lonlim = [1 360]; 
       ...
       fig_name = strcat('Diff_cldlow_CESM_2XCO2_PAPER_NEW');
        fig_dum = figure(2);
