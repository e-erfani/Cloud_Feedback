...
time = 1:100 ;
       fig_name = strcat('TOA_imblnc_TIME_SERIES_GLOBAL_neg_pos_smooth_10');%,num2str(tt));
        fig_dum = figure(3);
...
if (j==1)
    ...
    text(time(end)+10,double(var_Tseries_smooth(j,end))+0.15,num2str(nb(j)),'color',cl(j),'FontSize',18); hold on
elseif (j==3)
...
elseif (j==4)
    plot(time,squeeze(var_Tseries_smooth(j,:)),'color',cl(j),'linewidth',1) ; hold on;
    text(time(end)+0.5,double(var_Tseries_smooth(j,end))+0.05,num2str(nb(j)),'color',cl(j),'FontSize',18); hold on
else    
    plot(time,squeeze(var_Tseries_smooth(j,:)),'color',cl(j),'linewidth',1) ; hold on;
...
if (j==6)
    plot(time,squeeze(var_Tseries_smooth(j,:)),'--','color',cl(j),'linewidth',1) ; hold on;
    text(time(end)+10,double(var_Tseries_smooth(j,end))+0.05,num2str(nb(j)),'color',cl(j),'FontSize',18); hold on
elseif (j==7)
    plot(time,squeeze(var_Tseries_smooth(j,:)),'--','color',cl(j),'linewidth',1) ; hold on;
    text(time(end)+0.5,double(var_Tseries_smooth(j,end))+0.15,num2str(nb(j)),'color',cl(j),'FontSize',18); hold on
elseif (j==8)
    plot(time,squeeze(var_Tseries_smooth(j,:)),'--','color',purple,'linewidth',1) ; hold on;
    text(time(end)+5,double(var_Tseries_smooth(j,end))+0.1,num2str(nb(j)),'color',purple,'FontSize',18); hold on
else    
    plot(time,squeeze(var_Tseries_smooth(j,:)),'--','color',cl(j),'linewidth',1) ; hold on;
    text(time(end)+0.5,double(var_Tseries_smooth(j,end))+0.15,num2str(nb(j)),'color',cl(j),'FontSize',18); hold on
end
