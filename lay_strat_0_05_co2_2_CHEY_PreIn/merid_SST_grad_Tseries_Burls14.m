...
%%%%%%
time = 1:100%length(aa) ;
       fig_name = strcat('merid_grad_SST_Tseries_Burls2017');%,num2str(tt));
        fig_dum = figure(1);
...
%%%%%%
%time = 1:length(aa) ;
       fig_name = strcat('merid_grad_SST_Tseries_Burls2017_smooth_10');%,num2str(tt));
        fig_dum = figure(2);
      set(fig_dum, 'name', fig_name,'numbertitle','on');
      set(fig_dum,'units','inches','position',[0.3,0.3,12,9]);%,'PaperOrientation','landscape');
      set(fig_dum,'paperpositionmode','auto');
