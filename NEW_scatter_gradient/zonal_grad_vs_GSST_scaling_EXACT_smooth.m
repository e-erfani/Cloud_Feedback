...
%    d_qs_mean = d_qs(5);
    ...
    TT = (16+273.15):0.01:(26+273.15); 
    es_es=661.*exp((17.27.*(TT - 273.15))./(237.3+(TT-273.15))) ; 
...
%%%%%%%
       fig_name = strcat('zonal_grad_vs_GSST_scaling_EXACT_smooth');%,num2str(tt));
        fig_dum = figure(2);
    ...
    h3 = plot(TT-273.15,scaling,'color',purple,'LineWidth',3); hold on
